...
import { arrToBufArr, bufArrToArr, toBuffer } from '@nomicfoundation/ethereumjs-util'
...
function createBlock(
  ...
  const uncleHash = keccak256(arrToBufArr(RLP.encode(bufArrToArr(uncles.map((uh) => uh.raw())))))
